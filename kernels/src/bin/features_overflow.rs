...
#[no_mangle]
#[inline(never)]
pub extern "C" fn subarray_add(index: i32, list1: &[i32; LIST_LEN], list2: &[i32; LIST_LEN], out: &mut [i32; OUT_LEN]) {
    for i in 0..OUT_LEN {
...
fn rust_entry() {
    ...
    let list1: [i32; LIST_LEN] = [1, 2, 1500000000, 4, 5];
    let list2: [i32; LIST_LEN] = [1, 2, 1500000000, 4, 5];
    let mut out: [i32; OUT_LEN] = [0; OUT_LEN];
    for i in 0..NUM_TRIALS {
        subarray_add(indices[i], &list1, &list2, &mut out);
    }
}
