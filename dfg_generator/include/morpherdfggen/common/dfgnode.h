...
enum HyCUBEIns{NOP,ADD,ADD_WO,UADD_WO,SUB_WO,SUB,MUL,MUL_WO,UMUL_WO,ABS,SEXT,DIV,LS,RS,ARS,AND,OR,XOR,SELECT,CMERGE,CMP,PCMP,NCMP,CLT,BR,CGT,LOADCL,MOVCL,Hy_LOAD,Hy_LOADH,Hy_LOADB,Hy_P_LOADD,Hy_STORE,Hy_STOREH,Hy_STOREB,Hy_P_STORED,JUMPL,MOVC,PANIC};
...
//			void addPHIAncestorNode(dfgNode* node){PHIAncestorNodes.push_back(node);}
			...
			//Add CMerge Child
			dfgNode* addCMergeParent(dfgNode* phiBRAncestor,dfgNode* phiDataAncestor=NULL,int64_t constVal=-1, bool selectOp=false);
			...
			dfgNode* addCMergeParent(Instruction* phiBRAncestorIns,int64_t constVal);
