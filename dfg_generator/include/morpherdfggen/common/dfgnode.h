...
enum HyCUBEIns{NOP,ADD,ADD_WO,SUB,MUL,MUL_WO,SEXT,DIV,LS,RS,ARS,AND,OR,XOR,SELECT,CMERGE,CMP,PCMP,NCMP,CLT,BR,CGT,LOADCL,MOVCL,Hy_LOAD,Hy_LOADH,Hy_LOADB,Hy_P_LOADD,Hy_STORE,Hy_STOREH,Hy_STOREB,Hy_P_STORED,JUMPL,MOVC,PANIC};
